...
[![Build Status](https://travis-ci.org/ppcsuite/ppcd/blockchain.png?branch=master)]
(https://travis-ci.org/ppcsuite/ppcd/blockchain)
...
[![GoDoc](https://godoc.org/github.com/ppcsuite/ppcd/blockchain?status.png)]
(http://godoc.org/github.com/ppcsuite/ppcd/blockchain)
...
http://localhost:6060/pkg/github.com/ppcsuite/ppcd/blockchain

## Installation

```bash
$ go get github.com/ppcsuite/ppcd/blockchain
```
