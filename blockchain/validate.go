...
func checkBlockSanity(params *chaincfg.Params, block *btcutil.Block, powLimit *big.Int, timeSource MedianTimeSource, flags BehaviorFlags) error { // ppc: params added
...
func (b *BlockChain) checkBlockContext(block *btcutil.Block, prevNode *blockNode, flags BehaviorFlags) error {
	...
	if !fastAdd {
		...
		if blockDifficulty != expectedDifficulty {
			log.Infof("maybeAcceptBlock : block %v, prevNode %v(%d)", header.BlockSha(), prevNode.hash, prevNode.bits)
