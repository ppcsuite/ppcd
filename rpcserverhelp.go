...
var helpDescsEnUS = map[string]string{
	...
	// ppc:
	"getkernelstakemodifier--synopsis":              "Get the stake modifier of a block.",
	"getkernelstakemodifier-verbose":                "Specifies the result is returned as a JSON object instead of a string.",
	"getkernelstakemodifier-hash":                   "Hash of the block.",
	"kernelstakemodifierresult-hash":                "Hash of the block.",
	"kernelstakemodifierresult-kernelstakemodifier": "Stake modifier of the block.",
	"getnextrequiredtarget--synopsis":               "Get the difficulty target for the next block.",
	"getnextrequiredtarget-proofofstake":            "Specifies the difficulty target is for a proof-of-stake block.",
	"getnextrequiredtarget-verbose":                 "Specifies the result is returned as a JSON object instead of a string.",
	"nextrequiredtargetresult-target":               "Difficulty target.",
	"getlastproofofworkreward--synopsis":            "Get the last proof-of-work reward.",
	"sendcoinstaketransaction--synopsis":            "Mint a block using a coinstake transaction.",
	"sendcoinstaketransaction-hextx":                "Serialized, hex-encoded signed coinstake transaction.",
	"sendcoinstaketransactioncmd-hextx":             "Serialized, hex-encoded signed coinstake transaction.",
	"sendmintblocksignature--synopsis":              "Submit a minted block to the network.",
	"sendmintblocksignature-hextx":                  "Hash of the coinstake transaction that was used to mint the block.",
	"sendmintblocksignature-hexsignature":           "Signature of the minted block.",
	"sendmintblocksignaturecmd-hextx":               "Hash of the coinstake transaction that was used to mint the block.",
	"sendmintblocksignaturecmd-hexsignature":        "Signature of the minted block.",
}
